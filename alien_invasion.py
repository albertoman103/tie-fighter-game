...
class AlienInvasion:
    ...
    def _check_play_button(self, mous_pos):
        """Start a nwe game when the player clicks play."""
    ...
    def _create_fleet(self):
        ...
        # Make a tie fighter and find the number of tie fighters in a row
        ...
        # Create the 1st row of tie fighters
    ...
    def _create_alien(self, alien_number, row_number):
        """Create a tie fighter and place it in the row."""
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _update_aliens(self):
        ...
        Update the positions of all the tie fighters.
        """
    ...
    def _check_aliens_bottom(self):
        """Check if any aliens have reached the bottome of the
        screen."""
